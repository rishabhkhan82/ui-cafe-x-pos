...
export class InventoryManagementComponent implements OnInit {
  ...
  private initializeData(): void {
    // Initialize with mock data for kitchen manager
    this.currentUser = this.mockDataService.getUserByRole('kitchen_manager') || null;
    this.loadInventoryFromService();
  }

  private loadInventoryFromService(): void {
  ...
  private loadInventoryData(): void {
    // Data is loaded via subscription in initializeData
  }
